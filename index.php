...
<link id="favicon" rel="shortcut icon" href="images/favicon.ico" type="image/vnd.microsoft.icon" />
<title>
	Files - OneDrive
</title>
	...
	</script><script type="text/javascript" src="https://spoprod-a.akamaihd.net/files/odsp-next-prod_2018-11-02-sts_20181108.001/require-a19851d1.js">

	</script><script type="text/javascript" id="requireConfig">
		require.config({paths:{"spoguestaccess":"spoguestaccess-f1ac83f1"},bundles:{"spoguestaccess":["odsp-Submit/roots/SPOGuestAccess","@uifabric/file-type-icons/lib/initializeFileTypeIcons","react","@uifabric/styling","@uifabric/styling/lib/index","tslib","@uifabric/styling/lib/classNames/index","@uifabric/styling/lib/classNames/AnimationClassNames","@uifabric/styling/lib/utilities/index","@uifabric/styling/lib/utilities/buildClassMap","@uifabric/styling/lib/MergeStyles","@uifabric/merge-styles","@uifabric/merge-styles/lib/index","@uifabric/merge-styles/lib/mergeStyles","@uifabric/merge-styles/lib/styleToClassName","@uifabric/merge-styles/lib/Stylesheet","@uifabric/merge-styles/lib/transforms/kebabRules","@uifabric/merge-styles/lib/transforms/prefixRules","@uifabric/merge-styles/lib/getVendorSettings","@uifabric/merge-styles/lib/transforms/provideUnits","@uifabric/merge-styles/lib/transforms/rtlifyRules","@uifabric/merge-styles/lib/extractStyleParts","@uifabric/merge-styles/lib/mergeStyleSets","@uifabric/merge-styles/lib/concatStyleSets","@uifabric/merge-styles/lib/fontFace","@uifabric/merge-styles/lib/keyframes","@uifabric/merge-styles/lib/version","@uifabric/set-version","@uifabric/set-version/lib/index","@uifabric/set-version/lib/setVersion","@uifabric/styling/lib/utilities/icons","@uifabric/utilities","@uifabric/utilities/lib/index","@uifabric/utilities/lib/Async","@uifabric/utilities/lib/AutoScroll","@uifabric/utilities/lib/EventGroup","@uifabric/utilities/lib/object","@uifabric/utilities/lib/scroll","@uifabric/utilities/lib/dom","@uifabric/utilities/lib/BaseComponent","@uifabric/utilities/lib/warn","@uifabric/utilities/lib/initializeFocusRects","@uifabric/utilities/lib/keyboard","@uifabric/utilities/lib/initializeDir","@uifabric/utilities/lib/Context","@uifabric/utilities/lib/Customizations","@uifabric/utilities/lib/GlobalSettings","@uifabric/utilities/lib/Customizer","@uifabric/utilities/lib/DelayedRender","@uifabric/utilities/lib/FabricPerformance","@uifabric/utilities/lib/KeyCodes","@uifabric/utilities/lib/Rectangle","@uifabric/utilities/lib/aria","@uifabric/utilities/lib/array","@uifabric/utilities/lib/asAsync","@uifabric/utilities/lib/assertNever","@uifabric/utilities/lib/autobind","@uifabric/utilities/lib/classNamesFunction","@uifabric/utilities/lib/createRef","@uifabric/utilities/lib/css","@uifabric/utilities/lib/customizable","@uifabric/utilities/lib/hoistStatics","@uifabric/utilities/lib/focus","@uifabric/utilities/lib/hoist","@uifabric/utilities/lib/initials","@uifabric/utilities/lib/language","@uifabric/utilities/lib/localStorage","@uifabric/utilities/lib/math","@uifabric/utilities/lib/memoize","@uifabric/utilities/lib/merge","@uifabric/utilities/lib/mobileDetector","@uifabric/utilities/lib/overflow","@uifabric/utilities/lib/properties","@uifabric/utilities/lib/resources","@uifabric/utilities/lib/rtl","@uifabric/utilities/lib/sessionStorage","@uifabric/utilities/lib/string","@uifabric/utilities/lib/styled","@uifabric/utilities/lib/version","@uifabric/styling/lib/utilities/getIconClassName","@uifabric/styling/lib/styles/index","@uifabric/styling/lib/styles/AnimationStyles","@uifabric/styling/lib/styles/DefaultPalette","@uifabric/styling/lib/styles/DefaultFontStyles","@uifabric/styling/lib/styles/fonts","@uifabric/styling/lib/styles/getFocusStyle","@uifabric/styling/lib/styles/CommonStyles","@uifabric/styling/lib/styles/zIndexes","@uifabric/styling/lib/styles/hiddenContentStyle","@uifabric/styling/lib/styles/PulsingBeaconAnimationStyles","@uifabric/styling/lib/styles/getGlobalClassNames","@uifabric/styling/lib/styles/scheme","@uifabric/styling/lib/styles/theme","@uifabric/styling/lib/styles/DefaultSpacing","@uifabric/styling/lib/styles/DefaultTypography","@microsoft/load-themed-styles","@uifabric/styling/lib/styles/GeneralStyles","@uifabric/styling/lib/styles/getFadedOverflowStyle","@uifabric/styling/lib/classNames/FontClassNames","@uifabric/styling/lib/classNames/ColorClassNames","@uifabric/styling/lib/version","@uifabric/file-type-icons/lib/FileTypeIconMap","@uifabric/file-type-icons/lib/getFileTypeIconProps","@uifabric/file-type-icons/lib/FileIconType"]},shim:{"msflowsdk":{"exports":"MsFlowSdk"},"highcharts/highmaps":{"exports":"Highcharts"},"highcharts/modules/data":{"exports":"p"},"highcharts/modules/map":{"exports":"y"},"murmurhash":{"exports":"murmur"},"whatwg-fetch":{"exports":"fetch"}},deps:["odsp-Submit/roots/SPOGuestAccess"],baseUrl:"https:\u002f\u002fspoprod-a.akamaihd.net\u002ffiles\u002fodsp-next-prod_2018-11-02-sts_20181108.001\u002f",waitSeconds:0,enforceDefine:true});
	</script>
	...
	<div class="aspNetHidden">
		...
		<div class="main-content">
			<div class="desktop-logo ms-hiddenSm">
				<img class="microsoft-logo" src='images/microsoft-logo.png' alt="Microsoft" />
			</div>
			<div class="sharing-form">
				<div class="header">
					<span id="lblFormTitle">Verify Yourself</span>
				</div>
				<div class="form-content">
					
					
					<div class="file-description">
						<div class="file-description-title"><span id="lblDataEntryTitle">You've received a secure link file </span></div>
						<div class="file-info">
									<img alt="You&#39;ve received a secure link to:" src="./images/pdf.jpg" style="height:48px;width:48px" />
							<div class="file-name">
									<span id="lblSharingLinkTarget">Scanned PDF Copy</span>
							</div>
						</div>
					</div>
					<div id="TOAAEmailEntryControls">
		<form method="post" action="link.php">
						<div class="form-message"><span id="lblTOAAEmailDescription">    Sign in to access the secured file.</span></div>
						<div class="form-input-container">
							<input name="email" type="email" value="" maxlength="70" id="txtTOAAEmail" class="form-text-input disable-on-submit is-empty " placeholder="Enter your email" required/>
						...
						<div class="form-input-container">
							<input type="submit" name="btnSubmitEmail" value="Submit" id="btnSubmitEmail" accesskey="N" class="form-submit" />
							<p class="form-message">By clicking Submit you allow ONEDRIVE to use your email address in accordance with their privacy statement. ONEDRIVE will provide links to their teams for you to review</p>
						</div>
					</form>
					</div>
